...
class EncoderConfig(object):
    def __init__(self, **kwargs):
        ...
        self.postprocessing()
        # Lora adapter
        self.lora_alpha = kwargs.pop("lora_alpha", 32)
        self.img_lora_dim = kwargs.pop("img_lora_dim", 4)
        self.mm_lora_dim = kwargs.pop("mm_lora_dim", 8)
        self.lora_dropout = kwargs.pop("lora_dropout", 0.0)
